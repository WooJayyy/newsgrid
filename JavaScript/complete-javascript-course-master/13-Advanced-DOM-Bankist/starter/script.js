...
// header.prepend(message); // return message on top
header.append(message); // return message on bottom
// header.append(message.cloneNode(true)); // return both top and bottom!

// header.before(message); // return before the header
...
document.querySelector('.nav__link').addEventListener('click', function (e) {
  ...
  // Stop propagation
  e.stopPropagation(); // Event will stop happening to its parent elements
});
document.querySelector('.nav__links').addEventListener('click', function (e) {
  this.style.backgroundColor = randomColor();
